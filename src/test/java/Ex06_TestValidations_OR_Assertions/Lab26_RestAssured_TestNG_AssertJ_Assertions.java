...
public class Lab26_RestAssured_TestNG_AssertJ_Assertions {
    ...
    public void test_POST() {
        ...
        validatableResponse.body("booking.firstname", Matchers.equalTo("Swapnali"));
        validatableResponse.body("booking.lastname", Matchers.equalTo("Khairnar"));
        ...
        Assert.assertEquals(firstname, "Swapnali");
        Assert.assertEquals(lastname, "Khairnar");
        Assert.assertNotNull(bookingId);

        // AssertJ
        assertThat(bookingId).isPositive().isNotNull().isNotZero();
        assertThat(firstname).isNotEmpty().isNotBlank().isNotNull().isEqualTo("Swapnali");
